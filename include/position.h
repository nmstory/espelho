...
struct Position : public Replicable {
    ...
    bool process(WriteStream& s) override { return process_pod(s, m_X) && process_pod(s, m_Y); }
    bool process(ReadStream& s)  override { return process_pod(s, m_X) && process_pod(s, m_Y); }
